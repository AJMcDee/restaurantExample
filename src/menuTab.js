...
export function populateMenuTab(){
    ...
    let item1 = new MenuItem("Tiramisu", "Delicious tiramisu is so delicious!", "$3.99")
    item1.insert()

    let item2 = new MenuItem("Spaghetti Bolognese", "Mmmm a classic from mama's kitchen", "$9.99")
    item2.insert()

    let item3 = new MenuItem("Carbonara", "ITSA SO CREAMY", "$11.80")
    item3.insert()
